...
* 对应测试类： https://github.com/huojuntao/api-gateway-demo-sign-java-master/blob/master/src/test/java/org/logink/cloud/api/gateway/demo/main/MessageSendPlatformSmsDemo.java
*/
public class MessageSendPlatformSmsDemo {
	public static void main(String[] args) {
		String appkey = "您的appkey";
		String appsecret = "您的appsecret";
		String url = "https://gateway.logink.org/message/sms/sendPlatformSms";
		//请求的body,json格式
